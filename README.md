<div align="center">
  <img src="public/icons/icon.png" alt="ZickZack Client" width="120" />
...
ZickZack Client is a cross-platform desktop launcher built with React, Tauri, and Rust. It provides an opinionated setup for Minecraft with a neon dark-green aesthetic, profile management, automatic updates, and an optional FPS Booster that tunes both the launcher and the game for low-latency play.
...
ZickZack Client stores persistent configuration in the `launcher-config.json` file. Notable settings include:
